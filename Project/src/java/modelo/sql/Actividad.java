...
public class Actividad  implements java.io.Serializable {
    ...
    public Actividad(int idActividad, Area area, Profesor profesor, Tipo tipo, int ICupodisponible, int ICupomaximo, String SNombre, String SDescripciom, Date FFechamodificacion, Date FFechadescripion, Set actividadAlumnos, Set solicituds) {
       this.idActividad = idActividad;
       this.area = area;
       this.profesor = profesor;
       this.tipo = tipo;
